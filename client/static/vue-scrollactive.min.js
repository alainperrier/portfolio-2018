!(function(t, e) {
  'object' == typeof exports && 'object' == typeof module
    ...
    : 'function' == typeof define && define.amd
      ? define([], e)
      : 'object' == typeof exports ? (exports['vue-scrollactive'] = e()) : (t['vue-scrollactive'] = e())
})(this, function() {
  return (function(t) {
    function e(r) {
      ...
      var r = n(1),
        ...
        u = function(t, e, n) {
          var s,
            ...
            y = v ? o : o[e] || (o[e] = {}),
            _ = y.prototype,
            w = v ? r : p ? r[e] : (r[e] || {}).prototype
          v && (n = e)
          for (s in n)
            ((a = !l && w && void 0 !== w[s]) && s in y) ||
              ((f = a ? w[s] : n[s]),
              (y[s] =
              ...
              d && (((y.virtual || (y.virtual = {}))[s] = f), t & u.R && _ && !_[s] && c(_, s, f)))
        }
    ...
    function(t, e, n) {
      ...
      t.exports = function(t, e, n, h, m, y, _) {
        a(n, e, h)
        var w,
          x,
          g,
          ...
          A = !1,
          j = t.prototype,
          E = j[v] || j['@@iterator'] || (m && j[m]),
          I = E || b(m),
          T = m ? (S ? b('entries') : I) : void 0,
          P = 'Array' == e ? j.entries || E : E
        if (
          (P && (g = l(P.call(new t()))) !== Object.prototype && (f(g, O, !0), r || u(g, v) || c(g, v, d)),
          S &&
            E &&
            'values' !== E.name &&
            ((A = !0),
          ...
          if (((w = { values: S ? I : b('values'), keys: y ? I : b('keys'), entries: T }), _))
    ...
    function(t, e, n) {
      ...
      ;(v && p) ||
        ...
        'process' == n(11)(l)
          ...
          : d
            ? ((o = new d()), (i = o.port2), (o.port1.onmessage = _), (r = c(i.postMessage, i, 1)))
    ...
    function(t, e, n) {
      ...
      ;(i.install = function(t) {
        i.install.installed || t.component('scrollactive', o.default)
      }),
        'undefined' != typeof window && window.Vue && i.install(window.Vue),
        (e.default = i)
    },
    function(t, e, n) {
      var r = n(39)(n(40), n(75), null, null, null)
      t.exports = r.exports
    },
    function(t, e) {
    ...
    function(t, e, n) {
      ...
      e.default = {
        ...
        beforeDestroy: function() {
          window.removeEventListener('scroll', this.onScroll), window.cancelAnimationFrame(this.scrollAnimationFrame)
        },
        methods: {
          onScroll: function(t) {
            ;(this.currentItem = this.getItemInsideWindow()),
          ...
          getItemInsideWindow: function() {
            ...
            return (
              [].forEach.call(this.items, function(n) {
                var r = document.getElementById(n.hash.substr(1)),
                  o = window.pageYOffset >= t.getOffsetTop(r) - t.offset,
                  i = window.pageYOffset < t.getOffsetTop(r) - t.offset + r.offsetHeight
                t.exact && o && i && (e = n), !t.exact && o && (e = n)
              }),
              e
            )
          },
          initScrollactiveItems: function() {
            var t = this
            if (((this.items = this.$el.querySelectorAll('.scrollactive-item')), this.clickToScroll))
              return void [].forEach.call(this.items, function(e) {
          ...
          handleClick: function(t) {
            ...
            var n = t.currentTarget.hash,
              r = document.getElementById(n.substr(1))
            if (!r)
              return void console.warn(
                "[vue-scrollactive] Element '" + n + "' was not found. Make sure it is set in the DOM."
              )
            this.alwaysTrack ||
          ...
          scrollTo: function(t) {
            ...
            return new u.default(function(n) {
              var r = e.getOffsetTop(t),
                ...
                c = r - o,
                u = e.bezierEasing.apply(e, (0, i.default)(e.cubicBezierArray)),
                s = null,
                a = function t(r) {
                  s || (s = r)
                  var i = r - s,
                    a = i / e.duration
                  i >= e.duration && (i = e.duration), a >= 1 && (a = 1)
                  var f = o + u(a) * (c - e.offset)
                  window.scrollTo(0, f),
                    i < e.duration
                      ? (e.scrollAnimationFrame = window.requestAnimationFrame(t))
                      : (window.addEventListener('scroll', e.onScroll), n())
                }
    ...
    function(t, e, n) {
      n(22), n(57), (t.exports = n(2).Array.from)
    },
    function(t, e, n) {
      var r = n(12),
        o = n(13)
      t.exports = function(t) {
        return function(e, n) {
          ...
          return s < 0 || s >= a
            ? t ? '' : void 0
            : ((i = u.charCodeAt(s)),
              i < 55296 || i > 56319 || s + 1 === a || (c = u.charCodeAt(s + 1)) < 56320 || c > 57343
                ? t ? u.charAt(s) : i
                : t ? u.slice(s, s + 2) : c - 56320 + ((i - 55296) << 10) + 65536)
        }
      }
    },
    function(t, e, n) {
    ...
    function(t, e, n) {
      ...
      t.exports =
        ...
        function(t, e) {
          var n
          return (
            null !== t ? ((u.prototype = r(t)), (n = new u()), (u.prototype = null), (n[c] = t)) : (n = s()),
            void 0 === e ? n : o(n, e)
          )
        }
    },
        ...
        'Array',
        {
          from: function(t) {
            var e,
              ...
              y = 0,
              _ = f(v)
            if ((m && (h = r(h, d > 2 ? arguments[2] : void 0, 2)), void 0 == _ || (p == Array && u(_))))
              for (e = s(v.length), n = new p(e); e > y; y++) a(n, y, m ? h(v[y], y) : v[y])
            else
              for (l = _.call(v), n = new p(); !(o = l.next()).done; y++)
                a(n, y, m ? c(l, h, [o.value, y], !0) : o.value)
            return (n.length = y), n
          }
        }
      )
    ...
    function(t, e, n) {
      n(61), n(22), n(62), n(66), (t.exports = n(2).Promise)
    },
    function(t, e) {},
    function(t, e, n) {
      n(63)
    ...
    function(t, e, n) {
      ...
      var r,
        ...
        O = !!(function() {
          try {
            ...
            return (g || 'function' == typeof PromiseRejectionEvent) && t.then(b) instanceof e
          } catch (t) {}
        })(),
        S = function(t, e) {
          return t === e || (t === x && e === i)
              ...
              for (var r = t._v, o = 1 == t._s, i = 0; n.length > i; )
                !(function(e) {
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && C(t), (t._h = 1)),
                        !0 === c ? (n = r) : (a && a.enter(), (n = c(r)), a && a.exit()),
        ...
        C = function(t) {
          m.call(u, function() {
            var e
            g ? w.emit('rejectionHandled', t) : (e = u.onrejectionhandled) && e({ promise: t, reason: t._v })
          })
        },
        k = function(t) {
          var e = this
      ...
      O ||
        ((x = function(t) {
          p(this, x, 'Promise', '_h'), v(t), r.call(this)
          try {
        ...
        (r.prototype = n(72)(x.prototype, {
          then: function(t, e) {
            var n = j(h(this, x))
            return (
              (n.ok = 'function' != typeof t || t),
              (n.fail = 'function' == typeof e && e),
              (n.domain = g ? w.domain : void 0),
              this._c.push(n),
        ...
        e = (t.exports = function(t, e, n, l, v) {
          ...
          if (i(y)) {
            for (p = u(t.length); p > w; w++)
              if ((m = e ? _(c((d = t[w]))[0], d[1]) : _(t[w])) === a || m === f) return m
          } else for (h = y.call(t); !(d = h.next()).done; ) if ((m = o(h, _, d.value, e)) === a || m === f) return m
        })
    ...
    function(t, e) {
      ...
      function u(t, e, n, r, o) {
        var c,
          ...
          s = 0
        do {
          ;(u = e + (n - e) / 2), (c = i(u, r, o) - t), c > 0 ? (n = u) : (e = u)
        } while (Math.abs(c) > f && ++s < l)
        return u
      }
      function s(t, e, n, r) {
        for (var o = 0; o < a; ++o) {
      ...
      t.exports = function(t, e, n, r) {
        function o(e) {
          for (var r = 0, o = 1, i = v - 1; o !== i && a[o] <= e; ++o) r += p
          --o
          var f = (e - a[o]) / (a[o + 1] - a[o]),
            l = r + f * p,
            d = c(l, t, n)
          return d >= 0.001 ? s(e, l, t, n) : 0 === d ? l : u(e, r, r + p, t, n)
        }
        if (!(0 <= t && t <= 1 && 0 <= n && n <= 1)) throw new Error('bezier x values must be in [0, 1] range')
        var a = d ? new Float32Array(v) : new Array(v)
        if (t !== e || n !== r) for (var f = 0; f < v; ++f) a[f] = i(f * p, t, n)
        return function(c) {
          return t === e && n === r ? c : 0 === c ? 0 : 1 === c ? 1 : i(o(c), e, r)
        }
      }
    },
    function(t, e) {
      t.exports = {
        render: function() {
          ...
          return (t._self._c || e)(
            'nav',
            { ref: 'scrollactive-nav-wrapper', staticClass: 'scrollactive-nav' },
            [t._t('default')],
            2
          )
        },
